		...
		<div class="row px-xl-5 pt-4 pb-2">
			<div class="col-lg-4 col-md-12 pr-3 pr-xl-5">
				<a href="" class="text-decoration-none">
					<h1 class="m-0 display-4 text-secondary"><span class="text-primary">ice</span>Cream</h1>
				</a>
				<p>Cửa hàng kem tươi số một Việt Nam, nhiều mã giảm giá hôm nay. Mua ngay!</p>
		...
		<div class="row border-top border-light mx-xl-5 py-4">
			<div class="col-md-6 px-xl-0">
				<p class="mb-md-0 text-lg-left">
					&copy; <a class="font-weight-semi-bold" href="#">iCream Shop</a>. Dự án báo cáo cuối kỳ học phần CT449.
					Thiết kế và cài đặt bởi Nguyễn Ngọc Trâm
				</p>
			</div>
